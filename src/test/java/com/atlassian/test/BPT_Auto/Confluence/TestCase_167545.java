...
import com.atlassian.test.BPT_Auto.PageFactory.Libra_Page_iFrame;
...
public class TestCase_167545 extends BaseTest {
    ...
    public void 话题外链校验测试_Chrome_Test() throws IOException {
        ...
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getChromeTest_167545_LayOut(), ProjectParams.getChromeDriverLocalPath());
        ...
        if (libraPageIndex.Ipt_AskUrl != null && libraPageIndex.Ipt_AskTextArea != null && libraPageIndex.Btn_AskSubmit != null) {
            ...
            libraPageIndex.Ipt_AskUrl.sendKeys(ProjectParams.getTargetSkuUrl_1());
            libraPageIndex.Ipt_AskTextArea.sendKeys(ProjectParams.getTargetDialogAskInput_4());
            libraPageIndex.Btn_AskSubmit.click();

            //断言点击创建话题后的返回结果
            testUtil.waitForTime(1000);
            if (libraPageIndex.Dlg_ActReturns_CreateTopic != null) {
                Assert.assertEquals(ProjectParams.getCreateTopicReturns_1(), libraPageIndex.Dlg_ActReturns_CreateTopic.getText());
            }

            //清空URL栏并未下次输入做准备
            libraPageIndex.cleanMyTopicContainerAskTextArea(chromeDriver, testUtil);

            //外链getTargetDialogAskInput_5()测试
            libraPageIndex.Ipt_AskTextArea.sendKeys(ProjectParams.getTargetDialogAskInput_5());
            libraPageIndex.Btn_AskSubmit.click();
            ...
            //外链getTargetDialogAskInput_6()测试
            libraPageIndex.Ipt_AskTextArea.sendKeys(ProjectParams.getTargetDialogAskInput_6());
            libraPageIndex.Btn_AskSubmit.click();
            ...
            //外链getTargetDialogAskInput_7()测试
            libraPageIndex.Ipt_AskTextArea.sendKeys(ProjectParams.getTargetDialogAskInput_7());
            libraPageIndex.Btn_AskSubmit.click();
    ...
    public void 话题外链校验测试_Firefox_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getFirefoxTest_167545_LayOut(), ProjectParams.getFireFoxDriverLocalPath());
    ...
    public void 话题外链校验测试_IE_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getIETest_167545_LayOut(), ProjectParams.getIEDriverLocalPath());
