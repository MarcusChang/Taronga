...
import com.atlassian.test.BPT_Auto.PageFactory.Libra_Page_PKTopic;
import com.atlassian.test.BPT_Auto.PageFactory.Libra_Page_PreIndex;
import com.atlassian.test.BPT_Auto.PageFactory.Libra_Page_StandardTopic;
...
public class TestCase_167543 {
    ...
    public void 话题页_首页侧滑条调整测试_首页_Chrome_Test() throws IOException {
        ...
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getChromeTest_167543_HomePage_LayOut(), ProjectParams.getChromeDriverLocalPath());

        Libra_Page_PreIndex libraPagePreIndex = new Libra_Page_PreIndex();
        Libra_Page_Index libraPageIndex = new Libra_Page_Index();

        // 让浏览器访问 Libra 京友邦首页
        libraPagePreIndex.OpenTargetURL(chromeDriver, ProjectParams.getLibraURL());
    ...
    public void 话题页_首页侧滑条调整测试_盖楼话题_Chrome_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getChromeTest_167543_StdTopic_LayOut(), ProjectParams.getChromeDriverLocalPath());

        Libra_Page_PreIndex libraPagePreIndex = new Libra_Page_PreIndex();
        Libra_Page_StandardTopic libraPageStandardTopic = new Libra_Page_StandardTopic();

        // 让浏览器访问 Libra 京友邦盖楼话题页
        libraPagePreIndex.OpenTargetURL(chromeDriver, ProjectParams.getStandardTopicURL());
    ...
    public void 话题页_首页侧滑条调整测试_PK话题_Chrome_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getChromeTest_167543_PKTopic_LayOut(), ProjectParams.getChromeDriverLocalPath());

        Libra_Page_PreIndex libraPagePreIndex = new Libra_Page_PreIndex();
        Libra_Page_PKTopic libraPagePkTopic = new Libra_Page_PKTopic();

        // 让浏览器访问 Libra 京友邦首页
        libraPagePreIndex.OpenTargetURL(chromeDriver, ProjectParams.getPKTopicURL());
    ...
    public void 话题页_首页侧滑条调整测试_首页_Firefox_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getFirefoxTest_167543_HomePage_LayOut(), ProjectParams.getFireFoxDriverLocalPath());

        Libra_Page_PreIndex libraPagePreIndex = new Libra_Page_PreIndex();
        Libra_Page_Index libraPageIndex = new Libra_Page_Index();

        // 让浏览器访问 Libra 京友邦首页
        libraPagePreIndex.OpenTargetURL(firefoxDriver, ProjectParams.getLibraURL());
    ...
    public void 话题页_首页侧滑条调整测试_盖楼话题_Firefox_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getFirefoxTest_167543_StdTopic_LayOut(), ProjectParams.getFireFoxDriverLocalPath());

        Libra_Page_PreIndex libraPagePreIndex = new Libra_Page_PreIndex();
        Libra_Page_StandardTopic libraPageStandardTopic = new Libra_Page_StandardTopic();

        // 让浏览器访问 Libra 京友邦盖楼话题页
        libraPagePreIndex.OpenTargetURL(firefoxDriver, ProjectParams.getStandardTopicURL());
    ...
    public void 话题页_首页侧滑条调整测试_PK话题_Firefox_Test() throws IOException {
        ...
        // 让浏览器访问 Libra 京友邦首页
        libraPagePreIndex.OpenTargetURL(firefoxDriver, ProjectParams.getPKTopicURL());
    ...
    public void 话题页_首页侧滑条调整测试_首页_IE_Test() throws IOException {
        ...
        // 设置 IEdriver 的路径属性
        DesiredCapabilities ieCapabilities = testUtil.setIEdriverProperties(ProjectParams.getIEDriverLocalPath());
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getIETest_167543_HomePage_LayOut(), ProjectParams.getIEDriverLocalPath());
        ...
        // 让浏览器访问 Libra 京友邦首页
        libraPagePreIndex.OpenTargetURL(IEDriver, ProjectParams.getLibraURL());
    ...
    public void 话题页_首页侧滑条调整测试_盖楼话题_IE_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getIETest_167543_StdTopic_LayOut(), ProjectParams.getIEDriverLocalPath());

        Libra_Page_PreIndex libraPagePreIndex = new Libra_Page_PreIndex();
        Libra_Page_StandardTopic libraPageStandardTopic = new Libra_Page_StandardTopic();

        // 让浏览器访问 Libra 京友邦盖楼话题页
        libraPagePreIndex.OpenTargetURL(IEDriver, ProjectParams.getStandardTopicURL());
    ...
    public void 话题页_首页侧滑条调整测试_PK话题_IE_Test() throws IOException {
        ...
        //初始化LogUtilFunctions类，创建此类实例并设置当前测试用例的日志配置
        LogUtilFunctions logUtil = new LogUtilFunctions();
        logUtil.setLoggerProperties("TestCase_167543", ProjectParams.getIETest_167543_PKTopic_LayOut(), ProjectParams.getIEDriverLocalPath());

        Libra_Page_PreIndex libraPagePreIndex = new Libra_Page_PreIndex();
        Libra_Page_PKTopic libraPagePkTopic = new Libra_Page_PKTopic();

        // 让浏览器访问 Libra 京友邦首页
        libraPagePreIndex.OpenTargetURL(IEDriver, ProjectParams.getPKTopicURL());
