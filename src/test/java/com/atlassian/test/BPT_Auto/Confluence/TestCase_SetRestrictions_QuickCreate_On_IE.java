 ...
 */
public class TestCase_SetRestrictions_QuickCreate_On_IE extends BaseTest {
    ...
    public static void init() {
        ...
        logger = report.testLogger("TestCase_SetRestrictions_QuickCreate_On_IE");
        ...
        logUtil.setLoggerProperties("TestCase_SetRestrictions_QuickCreate_On_IE", ProjectParams.getTestCase_SetRestrictions_QuickCreate_On_IE_LayOut(), ProjectParams.getIEDriverLocalPath());
    ...
    public void TestAction_SetRestrictions_QuickCreate() {
        ...
        ConfluencePageNewBlankPage.Ipt_ContentTitle.sendKeys(ProjectParams.getIESetRestrictionsNewBlankPageTitle());
        ConfluencePageNewBlankPage.setTestCaseSetRestrictionsConfluencePageNewBlankPageMCEbody(ieDriver);
        ...
        ConfluencePageRestrictions.getConfluencePageRestrictionsElements(ieDriver);
        ...
        //Assert the page title == [TestCase_SetRestrictions_QuickCreate_On_IE Test Title :) - Confluence-AutoTest-Marcus - Confluence]
        Assert.assertTrue(ConfluencePageNewCreatedPage.Txt_PageTitle.equals("TestCase_SetRestrictions_QuickCreate_On_IE Test Title :) - Confluence-AutoTest-Marcus - Confluence"));
