...
public class TestCase_CreateNewPage_QuickCreate_On_Chrome extends BaseTest {
    ...
    public static void init() {
        ...
        logUtil.setLoggerProperties("TestCase_CreateNewPage_QuickCreate_On_Chrome", ProjectParams.getTestCase_CreateNewPage_On_Chrome_LayOut(), ProjectParams.getChromeDriverLocalPath());
    ...
    public void TestAction_CreateNewPage_QuickCreate() {
        ...
        ConfluencePageNewBlankPage.Ipt_ContentTitle.sendKeys(ProjectParams.getChromeQuickCreateNewBlankPageTitle());
        ConfluencePageNewBlankPage.Ipt_MceContentBody.sendKeys(ProjectParams.getChromeQuickCreateNewBlankPageBodyContent());
        ...
        //Assert the page title == [TestCase_CreateNewPage_QuickCreate_On_Chrome Test Title :) - Confluence-AutoTest-Marcus - Confluence]
        Assert.assertTrue(ConfluencePageNewCreatedPage.Txt_PageTitle.equals("TestCase_CreateNewPage_QuickCreate_On_Chrome Test Title :) - Confluence-AutoTest-Marcus - Confluence"));
